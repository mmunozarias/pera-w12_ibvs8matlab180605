...
T = [(m2*acl2^2*cos(q(2))^2 + m2*dcl2^2 + I1 + I2)^(1/2), 0;...
     (acl2*dcl2*m2*sin(q(2)))/(m2*acl2^2*cos(q(2))^2 + m2*dcl2^2 + I1 + I2)^(1/2), (I2 + acl2^2*m2 - (acl2^2*dcl2^2*m2^2*sin(q(2))^2)/(I1 + I2 + acl2^2*m2 + dcl2^2*m2 - acl2^2*m2*sin(q(2))^2))^(1/2)];
end
